    ...
    return (
        <div className="contact-page">
            <div className="container">
                <header className="contact-page__header fade-in">
                    ...
                    <div className="contact-page__info fade-in">
                        <div className="contact-info-card card">
                            ...
                            <div className="contact-links">
                                <a
                                    href="mailto:mattgraff0@gmail.com"
                                    className="contact-link"
                                >
                                    <span className="contact-link__icon"><MailIcon /></span>
                                    <span>mattgraff0@gmail.com</span>
                                </a>
                                <a
                                    href="https://github.com/ma-graff"
                                    target="_blank"
                                ...
                                <a
                                    href="https://www.linkedin.com/in/matt-graff/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="contact-link"
                                >
